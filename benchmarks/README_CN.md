...
并排工作区另有一份可由 COMSOL 6.3 打开并重建几何的**未求解二维 MPH 模型**，其路径、哈希及与本仓库 `.m` 的核对结果见 [`docs/COMSOL_2D_MODEL_AUDIT_CN.md`](../docs/COMSOL_2D_MODEL_AUDIT_CN.md)。该外部模型可用于重建参考计算；它不含可直接比较的求解场，也未随本仓库发布。
